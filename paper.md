...
**Cross-format parsing and harmonization.** It supports EyeLink .edf/.asc, Tobii text exports, GazePoint CSV exports, and webcam recordings produced through WebGazer through a unified conversion API, reducing friction when combining data from different acquisition systems. Pupil measurements and blink events are retained when they are present in the source recording rather than being discarded during harmonization.
